...
<img className={theme} src="../images/DH.png" alt='DH-logo'/>

<ul className="social">
  <li className="social-item">
    <a className="social-link" href="https://www.facebook.com/digitalhouseschool/?locale=es_LA">
  ...
  <li className="social-item">
    <a className="social-link" href="https://twitter.com/_digitalhouse?lang=es">
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  <li className="social-item">
    <a className="social-link" href="https://www.digitalhouse.com/ar">
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  <li className="social-item">
    <a className="social-link" href="https://www.instagram.com/_digitalhouse/?hl=es">
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
